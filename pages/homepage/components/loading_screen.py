...
class LoadingScreenPage(ft.UserControl):
        ...
        return ft.Container(
            content=ft.Column(
                controls=[
                    ...
                    ft.Container(
                        content=ft.Text(
                            "Our algorithm is curating the perfect group for your upcoming adventure. Hang tight—your plans are coming together!",
    ...
    def start_timer(self):
        def timer_thread():
            ...
            time.sleep(3)
            self.page.go("/bookingsuccessful")
