...
class CancelledPage:
    ...
    def build(self):
        ...
        def booking_card(restaurant_name, date_time, location, tag, order_id, status):
            return ft.Container(
                content=ft.Column(
                    [
                        ft.Row(
                            [
                                ft.CircleAvatar(
                                    content=ft.Icon(ft.icons.LOCATION_ON, size=20),
                                    bgcolor="#1A1A1A",
                                ),
                                ft.Text(
                                    restaurant_name,
                        ...
                        ft.Row(
                            [
                                ft.Container(
                                    content=ft.Text(tag, color="#FFFFFF", size=10),
                                    padding=ft.padding.symmetric(
